...
const features = [
  {
    ...
    titleItalic: "XRay",
    titleBold: " Vision",
    description: "Search and summarise relevant information along with sources across 1000+ page projects",
    tabIcon: "/images/scan-tab-icon.png",
    image: "/images/Frame-46.gif",
    sectionHeight: "min-h-[769px]",
    cardTopOffset: "pt-[243px]",
  },
  {
    label: "TAKEOFFS",
    titleItalic: "AI",
    titleBold: " Drawing Set",
    description: "Count, calculate and measure the drawings with precision accuracy using our best-in-class geometry models.",
    tabIcon: "/images/takeoff-tab-icon.png",
    image: "/images/Frame-47.gif",
    sectionHeight: "min-h-[690px]",
    cardTopOffset: "pt-[101px]",
  },
  {
    label: "ESTIMATE",
    titleItalic: "Price",
    titleBold: "GPT",
    description: "Find up-to-date pricing across 10Mn+ SKUs or connect historical bids for customised pricing",
    tabIcon: "/images/pricing-tab-icon.png",
    image: "/images/Frame-49.gif",
    sectionHeight: "min-h-[731px]",
    cardTopOffset: "pt-[107px]",
  },
];
  ...
  return (
    <section id="secret-sauce" className="bg-primary-dark-alt">
      <div className="mx-auto max-w-[1440px]">
        {/* Sticky Header */}
        <div className="sticky top-[72px] z-40 bg-primary-dark-alt px-[70px] pb-6 pt-16">
          ...
          {/* Tab Navigation */}
          <div className="mt-6 flex items-center gap-[67px]">
            {tabs.map((tab, index) => (
              <React.Fragment key={tab.name}>
                <a
                  href={tab.href}
                  className={`text-[18px] text-primary-lime transition-colors hover:underline ${index === 0 ? "underline decoration-2 underline-offset-4" : ""}`}
                >
                  {tab.name}
                </a>
                {index < tabs.length - 1 && (
        ...
        <div className="space-y-0">
          {features.map((feature) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`relative px-[81px] pb-16 ${feature.cardTopOffset} ${feature.sectionHeight}`}
            >
              {/* Dark inner card */}
              <Card variant="feature" className="relative mx-auto min-h-[466px] max-w-[1244px] overflow-hidden lg:grid lg:grid-cols-2">
                ...
                <div className="p-12">
                  ...
                  <h3 className="mt-2 text-[40px] leading-[35px]">
                    <span className="font-serif italic text-primary-lime">{feature.titleItalic}</span>
                ...
                {/* Image */}
                <div className="relative min-h-[300px] lg:min-h-[466px]">
                  <Image
                    src={feature.image}
