...
const steps = [
  ...
  {
    step: "STEP 2",
    title: "AI perform estimation at 4x speeds",
    description: "Forward-deployed estimators (FDEs) use AI to deliver BOQ / BOM quickly",
...
export default function SolutionSection() {
  return (
    <section id="how-it-works" className="bg-text-primary py-20 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] lg:py-28">
      <div className="mx-auto max-w-[1440px] px-[54px]">
        {/* Header */}
        <motion.div
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {steps.map((step, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative h-[334px] overflow-visible rounded-lg bg-primary-navy p-8"
            >
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <h3 className="mt-2 font-heading text-[32px] leading-tight text-primary-lime">
                  {step.title}
                </h3>
